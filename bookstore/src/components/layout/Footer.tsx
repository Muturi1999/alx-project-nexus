      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">ProDev Books</span>
            </div>
            <p className="text-gray-300 text-sm">
              Your premier destination for personal development, financial literacy, 
              and spiritual growth books. Empowering minds, transforming lives.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link href="/categories/growth" className="hover:text-white transition-colors">
                  Personal Growth
                </Link>
              </li>
              <li>
                <Link href="/categories/financial" className="hover:text-white transition-colors">
                  Financial Literacy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/categories/investment" className="hover:text-white transition-colors">
                  Investment & Trading
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} ProDev Books. All rights reserved. Built for ProDev Frontend Engineering Program.
          </p>
